...
var ContratosService = /** @class */ (function () {
    ...
    ContratosService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log('Fetching...');
                        return [4 /*yield*/, this.contratoRepository.find({
    ...
    ContratosService.prototype.findBySocio = function (socioId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
    ...
    ContratosService.prototype.findOne = function (id) {
    ...
    ContratosService.prototype.validateSocio = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var socioEntity;
            return __generator(this, function (_a) {
                switch (_a.label) {
