...
var ServiciosService = /** @class */ (function () {
    function ServiciosService(servicioRepository) {
    ...
    ServiciosService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ServiciosService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    ServiciosService = __decorate([
        common_1.Injectable(),
        __param(0, typeorm_1.InjectRepository(servicio_entity_1.Servicio))
    ], ServiciosService);
