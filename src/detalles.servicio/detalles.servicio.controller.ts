...
export class DetallesServicioController {
  ...
  @Get('/servicio:id')
  async findAllByServicio(@Param('id') id: string) {
    return this.detallesServicioService.findAllByServicio(+id);
  }
  @Get(':id')
  ...
  update(
    @Param('id') id: string,
    @Body() updateDetallesServicioDto: UpdateDetallesServicioDto,
  ) {
